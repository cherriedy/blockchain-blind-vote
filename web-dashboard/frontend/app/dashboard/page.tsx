...
export default function DashboardPage() {
    ...
    const submitResubmit = async () => {
        ...
        try {
            ...
            await publicApiService.resubmitSelfNomination(
                selectedNominationItem.electionId,
                formData
            );
            ...
            <main className="max-w-6xl mx-auto px-6 py-10">
                ...
                <div className="flex items-center gap-1 bg-white border border-slate-100 rounded-2xl p-1.5 mb-8 w-fit shadow-sm">
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activeTab === 'public'
                    ...
                    >
                        ...
                        {publicElections.length > 0 && (
                            <span className={`px-1.5 py-0.5 rounded-full text-[9px] ${activeTab === 'public' ? 'bg-white/20' : 'bg-slate-100 text-slate-500'}`}>
                    ...
                    >
                        ...
                        {selfNominations.length > 0 && (
                            <span className={`px-1.5 py-0.5 rounded-full text-[9px] ${activeTab === 'self-nominations'
                                ? 'bg-white/20'
