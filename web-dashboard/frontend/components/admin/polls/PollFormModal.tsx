...
export default function PollFormModal({ role, open, onClose, onSubmit, initialData, mode }: any) {
      ...
      <DialogContent className="max-w-2xl w-full h-[90vh] flex flex-col p-0">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm font-semibold mb-1">Chế độ hiển thị</p>
              <select
          ...
          <div className="space-y-3">
            <p className="text-sm font-semibold text-slate-700">Câu hỏi</p>
