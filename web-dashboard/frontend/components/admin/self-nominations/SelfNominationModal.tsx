                    ...
                    {data.map((item) => (
                        <Card key={item.id} className="p-4 space-y-3">
                            ...
                            <div className="text-sm space-y-1">
                                <p><b>Cuộc bầu cử:</b> {item.election?.name}</p>
                                <p><b>Giới thiệu:</b> {item.introduction || 'Không có'}</p>
                                <p><b>Admin xử lý:</b> {item.admin?.name || 'Chưa xử lý'}</p>
                            ...
                            {item.status === 'PENDING' && (
                                <div className="flex gap-2 pt-2">
                                    <Button
                                        size="sm"
                                        onClick={() => approve(item.candidateId)}
                                    >
                                        Duyệt
                                    </Button>
