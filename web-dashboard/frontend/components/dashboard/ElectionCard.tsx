                ...
                <div className="flex flex-wrap gap-3 pt-4 border-t border-slate-50">
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                            {(election.candidateIds?.length ?? 0) + (election.selfNominatedCandidates?.length ?? 0)} ứng viên
                        </span>
                    </div>
                    <div className="flex items-center gap-1.5">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 text-slate-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {election.endAt && (
                        <div className="flex items-center gap-1.5 ml-auto">
                            ...
                            <span className="text-[10px] font-bold text-slate-400">Hết: {formatDate(election.endAt)}</span>
                        </div>
                    )}
                </div>
            </div>
