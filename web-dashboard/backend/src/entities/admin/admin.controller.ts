...
export class AdminController {
  ...
  async create(@Body() body: CreateAdminRequestDto): Promise<AdminResponseDto> {
  ...
  async getById(@Param() param: AdminIdParamDto): Promise<AdminResponseDto> {
  ...
  async delete(@Param() param: AdminIdParamDto, @Request() req: any) {
    const currentAdminId = req.admin.id;
